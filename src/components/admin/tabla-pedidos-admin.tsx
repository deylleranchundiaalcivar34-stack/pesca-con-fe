...
import type { Order, OrderStatus } from "@/types/pedido";
...
// Renderiza las acciones disponibles segun el estado actual del pedido.
...
// Muestra el resumen de cliente, entrega y productos de un pedido.
...
// Reutiliza una fila label/valor dentro del detalle del pedido.
function Info({
  label,
  value,
  strong = false,
