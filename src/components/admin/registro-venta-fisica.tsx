  ...
  return <div className="grid gap-6 xl:grid-cols-[1.05fr_0.95fr]">
    ...
    <Card className="xl:sticky xl:top-6 xl:self-start">
      ...
      <CardContent className="space-y-4">
        ...
        <label className="grid gap-1.5 text-sm font-medium text-dark-blue">Nota o motivo del ajuste de precio<Textarea value={note} onChange={(event) => setNote(event.target.value)} placeholder="Obligatoria si modificas un precio; evita incluir datos personales innecesarios." maxLength={500} rows={3} /><span className="text-xs font-normal text-muted-foreground">Los precios normales se validan en la base. Un vendedor no puede modificarlos; los descuentos administrativos requieren motivo y tienen límites.</span></label>
