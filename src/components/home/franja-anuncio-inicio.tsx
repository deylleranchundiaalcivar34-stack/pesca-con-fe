...
export function HomeAnnouncementStrip() {
  ...
  return (
    <aside
      className="relative overflow-hidden border-y border-gold/55 bg-[#090909] text-white shadow-[0_5px_18px_rgb(0_0_0_/_0.16)]"
    ...
    >
      <div className="mx-auto flex h-10 max-w-[96rem] items-center gap-2 px-3 sm:h-11 sm:gap-4 sm:px-6 lg:px-8">
        <BadgePercent className="size-4 shrink-0 text-gold sm:size-5" aria-hidden="true" />
        ...
        <div className="relative h-5 min-w-0 flex-1 overflow-hidden" aria-hidden="true">
          <p className="home-announcement-message home-announcement-message-primary">
            <span className="text-gold">{promotionPercentage}%</span>
        ...
        <Sparkles className="size-4 shrink-0 text-gold sm:size-5" aria-hidden="true" />
      </div>
    </aside>
  );
}
